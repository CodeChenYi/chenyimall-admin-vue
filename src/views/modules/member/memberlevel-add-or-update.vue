          ...
          this.$http({
            ...
            if (data && data.code === 20000) {
              ...
              this.dataForm.freeFreightPoint =
                data.memberLevel.freeFreightPoint;
              this.dataForm.commentGrowthPoint =
                data.memberLevel.commentGrowthPoint;
              this.dataForm.priviledgeFreeFreight =
                data.memberLevel.priviledgeFreeFreight;
              this.dataForm.priviledgeMemberPrice =
                data.memberLevel.priviledgeMemberPrice;
              this.dataForm.priviledgeBirthday =
                data.memberLevel.priviledgeBirthday;
